...
namespace TweenManager
{
    ...
    {
        public static void ResumeTween(GameObject go)
        {
            ActionTween[] tweens = go.GetComponents<ActionTween>();

            foreach (ActionTween tween in tweens)
            {
                tween.isPaused = false;
            }
        }

        public static void PauseTween(GameObject go)
        {
            ActionTween[] tweens = go.GetComponents<ActionTween>();
